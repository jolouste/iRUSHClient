...
const PieChart = () => {
	...
	useEffect(() => {
		const fetchChartData = async () => {
			...
			const categories = [
				...new Set(data.reopenedTickets.map(ticket => ticket.ticketCategory)),
			];
			...
			const ticketCategoryData = [
				...
				return data.reopenedTickets.filter(
					...
					<Pie
						...
						options={{
							...
							plugins: {
								...
								title: {
									display: true,
									text: "CURRENT REJECTED TICKETS ACCORDING TO CATEGORY",
								},
							},
						}}
					/>
